...
const About = () => {
  return (
    <>
      ...
      <div className="flex justify-center mt-10 mx-80 text-xl text-justify leading-8">
        <p>
          ...
          My goal is to develop responsive and beautiful <span className='text-rose-500'>Web Pages & Apps</span> which present the user with interface elements and interactions that facilitate usability and boost engagement.
          <br></br>
          <br></br>
