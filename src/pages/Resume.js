...
const Resume = () => {
  return (
    <>
      ...
      <div className="mt-10">
        <h2 className="text-2xl text-fuchsia-400 font-bold">STACK</h2>
      </div>
      <div className="grid-container mt-10 md:mx-40 sm:mx-10 grid sm:grid-cols-2 md:grid-cols-3 md:grid-rows-4 gap-x-4 gap-y-4 h-80 align-middle">
